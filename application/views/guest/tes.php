	...
	<head>
		...
		<!-- Favicon-->
		<link rel="shortcut icon" href="<?php echo base_url()."assets_utama/"; ?>img/fav.png">
		<!-- Author Meta -->
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">
									<form class="form-wrap">
										...
										<a href="#" class="primary-btn text-uppercase">Cari Paket Wisata</a>									
									</form>
								</div>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/d1.jpg" alt="">
								</div>
								<div class="desc">	
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/d2.jpg" alt="">
								</div>
								<div class="desc">	
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/d3.jpg" alt="">
								</div>
								<div class="desc">	
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/o1.jpg" alt="">					
								</div>
								<a href="#">
									<h4>Rent a Car</h4>
								</a>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/o2.jpg" alt="">					
								</div>
								<a href="#">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/o3.jpg" alt="">					
								</div>
								<a href="#">
									<h4>To Do List</h4>
								</a>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/o4.jpg" alt="">					
								</div>
								<a href="#">
									<h4>Food Features</h4>
								</a>
		            ...
		            <div class="row">
		                <div class="active-testimonial">
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/elements/user1.png" alt="">
		                        </div>
		                        <div class="desc">
		                            <p>
		                    ...
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/elements/user2.png" alt="">
		                        </div>
		                        <div class="desc">
		                            <p>
				...
				<div class="container-fluid">
					<div class="row align-items-center justify-content-end">
						...
						<div class="col-lg-6 col-md-12 home-about-right no-padding">
							<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/about-img.jpg" alt="">
						</div>
					</div>
				</div>	
			</section>
					...
					<div class="row">
						<div class="active-recent-blog-carusel">
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/b1.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
							...
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/b2.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
							...
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="<?php echo base_url()."assets_utama/"; ?>img-fluid" src="<?php echo base_url()."assets_utama/"; ?>img/b3.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
