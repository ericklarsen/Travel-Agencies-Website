				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Paket Wisata </a>  <span class="lnr lnr-arrow-right"></span>  <a href="packages.html"> Internasional</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="col-lg-10 active-hot-deal-carusel">
							...
							<div class="single-carusel">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img width="100px" src="<?php echo base_url()."assets_upload/paket_gambar/"; ?><?php echo $data['gambar_paket']; ?>" alt="">
								</div>
								<div class="price-detials">
									<a href="#" class="price-btn">Mulai dari <span><?php echo $data['harga_paket']; ?></span></a>
								</div>
								<div class="details">
				...
				<div class="container">
		            <div class="row d-flex justify-content-center">
		                <div class="menu-content pb-40 col-lg-8">
		                    <div class="title text-center">
		                        <h1 class="mb-10">Destinasi Terpopuler</h1>
					...
					<div class="row">
						<?php foreach ($paket as $data) { 
								if ($data['kategori_paket'] == "Internasional") {
				...
				<div class="container-fluid">
					<div class="row align-items-center justify-content-end">
						...
						<div class="col-lg-6 col-md-12 home-about-right no-padding">
							<img   src="<?php echo base_url()."assets_utama/"; ?>img/packages/about-img.jpg" alt="">
						</div>
					</div>
				</div>	
			</section>
