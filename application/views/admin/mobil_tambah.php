        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-example-wrap">
                    <form enctype="multipart/form-data" action="<?php echo site_url('Mobil/tambah_aksi');?>" method="POST">
                    ...
                    <div class="form-example-int mg-t-15">
                        <div class="form-group">
                            ...
                            <div class="nk-int-st">
                                <input type="text" name="namakendaraan" class="form-control input-sm" placeholder="Nama Kendaraan">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-example-int mg-t-15">
                        <div class="form-group">
                            ...
                            <div class="nk-int-st">
                                <input type="text" name="hargakendaraan" class="form-control input-sm" placeholder="Harga Kendaraan">
                            </div>
                        </div>
                    </div>
